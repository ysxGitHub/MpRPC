...
void protobuf_AssignDescriptors() {
  AddDescriptors();
  AssignDescriptors(
      "mprpcheader.proto", schemas, file_default_instances, TableStruct::offsets,
...
RpcHeader::RpcHeader()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_mprpcheader_2eproto::scc_info_RpcHeader.base);
  SharedCtor();
...
const ::google::protobuf::Descriptor* RpcHeader::descriptor() {
  ::protobuf_mprpcheader_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_mprpcheader_2eproto::file_level_metadata[kIndexInFileMessages].descriptor;
}

const RpcHeader& RpcHeader::default_instance() {
  ::google::protobuf::internal::InitSCC(&protobuf_mprpcheader_2eproto::scc_info_RpcHeader.base);
...
::google::protobuf::Metadata RpcHeader::GetMetadata() const {
  protobuf_mprpcheader_2eproto::protobuf_AssignDescriptorsOnce();
  return ::protobuf_mprpcheader_2eproto::file_level_metadata[kIndexInFileMessages];
}
