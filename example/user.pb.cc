...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::user::LoginResponse, sucess_),
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::user::RegisterRequest, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::user::RegisterRequest, id_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::user::RegisterRequest, name_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::user::RegisterRequest, pwd_),
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::user::RegisterResponse, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::user::RegisterResponse, result_),
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::user::RegisterResponse, sucess_),
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&::user::_RegisterRequest_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&::user::_RegisterResponse_default_instance_),
};
...
void UserServiceRpc::CallMethod(const ::google::protobuf::MethodDescriptor* method,
  ...
  switch(method->index()) {
    ...
    case 1:
      Register(controller,
             ::google::protobuf::down_cast<const ::user::RegisterRequest*>(request),
             ::google::protobuf::down_cast< ::user::RegisterResponse*>(response),
             done);
      break;
    default:
...
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::user::RegisterRequest* Arena::CreateMaybeMessage< ::user::RegisterRequest >(Arena* arena) {
  return Arena::CreateInternal< ::user::RegisterRequest >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::user::RegisterResponse* Arena::CreateMaybeMessage< ::user::RegisterResponse >(Arena* arena) {
